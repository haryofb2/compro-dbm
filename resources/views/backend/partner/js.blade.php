  ...
  <script>
    ...
    function load_data(from_date = '', to_date = '') {
        ...
        serverSide :true,
        ajax :{
            url:"{{route('backend_partner.index')}}",
            type:'GET'
        },
        columns:[
            {
    ...
    $('#form-tambah-edit').submit(function(evt) {
                ...
                var formData = new FormData(this);
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('backend_partner.store') }}", //url simpan data
                        ...
                        success: function (data) { //jika berhasil
                            ...
                            var oTable = $('#table_partner').dataTable(); //inialisasi datatable
    ...
    $('body').on('click', '.edit-post', function () {
        ...
        $.get('backend_partner/' + data_id + '/edit', function (data) {
    ...
    $('#tombol-hapus').click(function () {
        $.ajax({
            ...
            url: "backend_partner/" + dataId, //eksekusi ajax ke url ini
            type: 'delete',
            beforeSend: function () {
