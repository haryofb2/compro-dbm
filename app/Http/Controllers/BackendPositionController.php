...
class BackendPositionController extends Controller
{
    /**
    ...
    {
        return datatables ( Position::all())->toJson();
    }
     ...
     public function index(Request $request)
    {
        ...
        return view('backend.position.home',compact('position'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $post   =   Position::updateOrCreate(['id' => $id],
                    [
                        'name' => $request->name,
                    ]);
